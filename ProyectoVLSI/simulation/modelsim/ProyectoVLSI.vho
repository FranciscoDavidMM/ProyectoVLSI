...
-- ps2c	=>  Location: PIN_B10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ps2d	=>  Location: PIN_W6,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF kb_test IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
\ps2c~input\ : fiftyfivenm_io_ibuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
...
\ps2d~input\ : fiftyfivenm_io_ibuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	listen_to_nsleep_signal => "false",
